...
anime_query_engine = PandasQueryEngine(
    df=anime_df, verbose=False, instruction_str=instruction_str
)
...
while(prompt := input("Enter a prompt (q to quit): ")) != "q":
    try:
        ...
        print("I'm very sorry, I don't have the tools or data needed to answer that question. Please ask another question.")